    ...
    <div className="w-full min-h-screen bg-[#fcfaf2] batik-pattern overflow-x-hidden">
      ...
      <section className="h-screen relative flex flex-col items-center justify-center text-center px-6">
        ...
        >
          ...
          <p className="font-serif-elegant uppercase tracking-[0.5em] text-[#8b6e4e] text-xs mb-4">
            Undangan Pernikahan
          </p>
          <h1 className="font-traditional text-6xl md:text-8xl text-[#4a3728] leading-tight mb-4">
      ...
      <section className="min-h-screen flex items-center justify-center px-6 py-20 relative">
        <div className="max-w-lg w-full">
          ...
          >
            ...
            <p className="text-sm text-[#4a3728]/70 mb-6 italic font-serif-elegant">
              Spesial Mengundang Bapak/Ibu/Saudara/i
            </p>

            <div className="mb-10">
              <h2 className="text-4xl md:text-5xl font-serif-elegant text-[#4a3728] font-bold mb-4 break-words px-2">
                {to}
              </h2>
            ...
            <p className="text-xs text-[#4a3728]/60 uppercase tracking-[0.3em] leading-relaxed mb-12 max-w-xs mx-auto">
              Merupakan suatu kebahagiaan bagi kami apabila Anda berkenan hadir
            ...
            >
              ...
              />
              <span className="relative z-10 tracking-[0.2em] uppercase text-sm font-traditional">
                Buka Undangan
              </span>
            </motion.button>
          </motion.div>

          <p className="mt-12 text-center text-[10px] text-[#8b6e4e]/40 uppercase tracking-[0.4em]">
            Silakan klik tombol diatas untuk melihat isi undangan
          </p>
        </div>
      </section>
    </div>
